...
public class Main {
    public static void main(String[] args) {
        ...
        //service.impl.Practicaja practicaja2 = new service.impl.Practicaja();
...
//            System.out.println("Saldo despues del pago ###### :"+basico.buscarCuenta("5578123412340006")
//                    .getSaldo());
//
...
////                    practicaja.buscarCuenta("5578123412340006").getSaldo());  //34000
...
////                    practicaja.buscarCuenta("5578123412340006").getSaldo()); //42000
...
//               MinimumBalanceReachedException | BusinessException ex){ //X
//            ex.printStackTrace();
