public class PrestamoPersonal extends PrestamoBancario{
    ...
    public PrestamoPersonal(String folio, double monto, int plazoMeses, double tasaInteres, double saldoPendiente, String beneficiario, double ingresoMensual, String dirección, boolean avalRequerido) {
