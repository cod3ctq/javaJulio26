...
//Clases mapper: Se encargan de recibir y convertir un objeto de un tipo de dato a otro (pe: de Clase Entity a Clase Response)
public class CuentaMapper {
    ...
    public static CuentaResponse toResponse(Cuenta cuenta){
        return new CuentaResponse (cuenta.getCuentaId(),
                cuenta.getTipoCuentaId(), cuenta.getNumCuenta(),
                cuenta.getClabe(), cuenta.getSaldo(), cuenta.getFecha());
    }
