public class BoletoAvion extends Boleto {
    ...
    public BoletoAvion(String origen, String destino, String asiento, String terminal, String horaLlegada,
                       String horaSalida, String cliente, double kilosDocumentados) {
        this.origen = origen;
