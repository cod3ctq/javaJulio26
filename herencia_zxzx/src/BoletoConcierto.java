public class BoletoConcierto extends Boleto{
    ...
    //esto se logra añadiendo mas atribiutos y/o metodos
    ...
    public BoletoConcierto(String folio, String fecha, double precio, String evento,
                           String zona, String nombre, String empresa) {
