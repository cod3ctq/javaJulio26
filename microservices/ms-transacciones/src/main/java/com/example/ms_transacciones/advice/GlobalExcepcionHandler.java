package com.example.ms_transacciones.advice;

import com.example.ms_transacciones.errors.ApiErrors;
...
public class GlobalExcepcionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> AccountNotFoundException(RuntimeException ex) {
