...
public class CuentaServiceImpl implements CuentaService {
    ...
    */
    ...
    public CuentaResponse crearCuenta(CuentaRequest cuentaRequest) {
        TipoCuentaRecord tipoCuentaRecord = http.getForObject("http://localhost:8091/api/v1/catalogos/tipo-cuenta/by-id/" + cuentaRequest.getTipoCuentaId(),TipoCuentaRecord.class);
        Cuenta cuenta = null;
