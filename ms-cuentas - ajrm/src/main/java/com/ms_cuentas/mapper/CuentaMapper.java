...
//Clases Mappers : Se encargan de recibir y convertir un objeto de un tipo
//de dato, a otro
public class CuentaMapper {

    //No necesito una instancia al ser estatico
    //Solo le pide la info y siempre sera la misma
    //Toman la cuenta Request y se lo pasa a nueva cuenta
    ...
    public static Cuenta toUpdateEntity(Cuenta old, CuentaRequest request){
        old.setCuentaId(request.getClienteId());
