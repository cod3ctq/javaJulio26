...
//Manejador global de excepciones: Maneja la propagacion de cualquier recibe cion lanzada en cualquier punto del sistema
//de este servicio
//Maneja excepciones genericas (que vienen de ResponseEntityExceptionHandler)
//Maneja excepciones personalizadas (específicas del negocio) @ExceptionHandler
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> NotExistException(RuntimeException ex) {
