...
//Este manejador global de excepciones maneja la propagacion de cualquier excepcion
//lanzada en cualquier punto del sistema (de este servicio)
//Maneja excepciones genericas que vienen de ResponseEntityExceptionHandler
//Tambien maneja excepciones personalizadas, las especificas del negocio, @ExceptionHandler
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDoesNotExistException(RuntimeException ex) {
