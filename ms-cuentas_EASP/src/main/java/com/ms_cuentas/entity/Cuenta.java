...
//Serializacion: Desintegracion del estado de un objeto en bytes, para su envio
//Deserializacion: Reconstruccion del estado del objeto en bytes

@Entity //Convierte la clase POJO en una Entidad
@Table(name="CUENTAS") //Enlaza esta clase con la tabla
public class Cuenta implements Serializable {

    @Id //Diferencia el atributo que se usa como llave primaria en la tabla
    @Column(name = "CUENTA_ID", columnDefinition = "NUMBER") //Enlaza el atributo con la columna que representa
    @GeneratedValue(strategy = GenerationType.IDENTITY) //Indicar como se genera este dato en la base de datos
