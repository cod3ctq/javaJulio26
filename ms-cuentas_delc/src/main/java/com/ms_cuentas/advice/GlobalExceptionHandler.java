...
//Maneja excepciones genericas (que vienen de ResponseEntityExceptionHandler ) provienen del @Override
//Maneja excepciones personalizadas (especificas del negocio) denotadas por @ExceptionHandler
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //se agregan las excepciones personalizadas al manejar global
    ...
    @ExceptionHandler(AlreadyExisteSameAccountTypeException.class)
