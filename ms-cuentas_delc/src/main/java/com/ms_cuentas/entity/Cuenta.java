...
//Serialización: desintegración del estado de un objeto en bytes
//Deserialización Reconstrucción de estado del objeto en bytes

@Entity //convierte la clase POJO en una entidad
@Table (name="CUENTAS")//Enlaza esta clase con una tabla
public class Cuenta implements Serializable {
    ...
    @Column(name="CLABE",columnDefinition = "CHAR(10)")
