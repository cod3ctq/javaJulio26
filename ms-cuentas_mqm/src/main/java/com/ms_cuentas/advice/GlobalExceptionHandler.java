...
//este MAnejador global de excepciones: maneja la propagacion de cualquier excepcion lanzada
//en cualquier punto del sistema (de este servicio cuentas)
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUnderMinimumException(RuntimeException ex) {
        ApiErrors errores = new ApiErrors(ex.getMessage(), HttpStatusCode.valueOf(422),
                //422 valor que incumple una regla de negocio
                LocalDateTime.now());
        return ResponseEntity.status(HttpStatusCode.valueOf(422)).body(errores);
    }
    ...
    public ResponseEntity<Object> handleNotExistException(RuntimeException ex) {
        ApiErrors errores = new ApiErrors(ex.getMessage(), HttpStatusCode.valueOf(204),
                //204 la peticion si se proceso pero no existe el valor
                LocalDateTime.now());
    ...
    public ResponseEntity<Object> handleBussinessException(RuntimeException ex) {
        ApiErrors errores = new ApiErrors(ex.getMessage(), HttpStatusCode.valueOf(422),
                LocalDateTime.now());
        return ResponseEntity.status(HttpStatusCode.valueOf(422)).body(errores);
    }
