...
//Seralizacion desintegracion del estado de un objeto en bytes
//Deseriaizacion : reconstruccion
@Entity //Convierte en clase POJO en una Entidad
@Table(name="CUENTAS")  //Enlaza esta clase con la tabla
public class Cuenta implements Serializable {

        //solo en llave primaria Id (arriba del atributo)
        @Id
